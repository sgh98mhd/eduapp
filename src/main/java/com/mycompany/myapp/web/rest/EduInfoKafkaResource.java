...
@RestController
@RequestMapping("/api/edu-info-kafka")
public class EduInfoKafkaResource {

    private final Logger log = LoggerFactory.getLogger(EduInfoKafkaResource.class);
    ...
    public EduInfoKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
